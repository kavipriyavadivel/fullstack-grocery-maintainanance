...
const [items, setItems] = useState([]); // Initialize as an empty array
  ...
  const handleClick = (e) => {
    ...
    fetch('http://localhost:8080/grocery/add-return-list', {
      method: 'POST',
...
//                   <label htmlFor='pur'>Quantity:</label>
//                   <input type='text' className='space ms-3' required id='pur'></input>
//                 </div>
//                 <div className="labell-container d-flex flex-row mt-5">
//                   <label htmlFor='reason'>Reason:</label>
//                   <input type='text' className='space ms-5' required id='reason'></input>
//                 </div>
//               </div>
